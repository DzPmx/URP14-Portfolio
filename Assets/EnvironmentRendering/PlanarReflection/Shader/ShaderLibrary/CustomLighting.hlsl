...
CUSTOM_NAMESPACE_START(BxDF)
    ...
    half3 SimpleBRDF(HairLitData customLitData, CustomSurfacedata customSurfaceData, half3 L, half3 lightColor,
                     float shadow)
    {
    ...
    half3 ComplexBRDF(HairLitData customLitData, CustomSurfacedata customSurfaceData,
                  ...
                  float3 positionWS)
    {
        ...
        half mip=PerceptualRoughnessToRoughness(customSurfaceData.roughness);
        half3 encodedIrradiance=SAMPLE_TEXTURE2D_LOD(_PlanarReflectionTexture,sampler_PlanarReflectionTexture,customLitData.ScreenUV,mip);
        half3 specularLD = encodedIrradiance;
    ...
    half3 ComplexEnvBRDF(HairLitData customLitData, CustomSurfacedata customSurfaceData,
...
CUSTOM_NAMESPACE_START(DirectLighting)
    half3 SimpleShading(HairLitData customLitData, CustomSurfacedata customSurfaceData, float3 positionWS,
                        float4 shadowCoord)
    {
    ...
    half3 ComplexShading(HairLitData customLitData, CustomSurfacedata customSurfaceData,
...
CUSTOM_NAMESPACE_START(PBR)
    half4 SimpleLit(HairLitData customLitData, CustomSurfacedata customSurfaceData, float3 positionWS,
