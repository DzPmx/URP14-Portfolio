Shader "MyURPShader/Character Rendering/Burley Normalized LitSSS"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _SKINDIFFUSE_ON
            // -------------------------------------
                ...
                Pass
        {
            // Lightmode matches the ShaderPassName set in UniversalRenderPipeline.cs. SRPDefaultUnlit and passes with
            // no LightMode tag are also rendered by Universal Render Pipeline
            Tags{"LightMode" = "Burley Normalized Dual Specular"}
            ...
            // Material Keywords
            #pragma shader_feature_local_fragment _ALPHATEST_ON
            #pragma shader_feature_local_fragment _SKINSPECULAR_ON
