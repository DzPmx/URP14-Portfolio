...
namespace RenderFeature.SeparableSSS
{
    public class SeparablSSSFeature : ScriptableRendererFeature
    {
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            separablSSS.ConfigureInput(ScriptableRenderPassInput.Color);
    ...
    internal class SeparablSSSPass : ScriptableRenderPass
    {
        ...
        static readonly int sssTextureID = Shader.PropertyToID("_SSSTexture");
