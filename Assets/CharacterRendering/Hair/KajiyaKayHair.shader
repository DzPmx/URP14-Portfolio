Shader "MyURPShader/Character Rendering/KajiyaKay Hair"
{
    Properties
    {
        ...
        _SpecularWidth("SpecualrWidth",Range(0,2)) = 1
        _SpecPower("SpecualrPower",Range(1,200)) = 1
        _SpecualrScale("SpecualrScale",Range(0,10)) = 1
        _FuzzySpecualr("FuzzySpecualr",Range(0,1)) = 1
        _Roughness("Roughness",range(0,1))=0.5

        _Scatter("Scattering",Range(0,1)) = 0.5
        _PrimaryShift("PrimaryShift",Range(-1,1)) = 0.5
        _PrimaryColor("PrimaryColor", Color) = (1,1,1,1)
        _SecondaryShift("SecondaryShift",Range(-1,1)) = 0.5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment HairKajiyaKayOpaqueFragment
        ...
        Pass
        {
            ...
            #pragma vertex LitPassVertex
            #pragma fragment HairKajiyaKayTransparentFragment
