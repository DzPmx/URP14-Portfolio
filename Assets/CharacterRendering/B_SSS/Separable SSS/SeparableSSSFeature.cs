...
namespace SSS.Separable_SSS
{
    ...
    internal class SeparablSSSPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            float subsurfaceScaler = renderingData.cameraData.camera.pixelWidth > 1920
                ? renderingData.cameraData.camera.pixelWidth
                : 1920;
            material.SetFloat(sssScalerID, settings.subsurfaceScaler*(float)(subsurfaceScaler/1920));
