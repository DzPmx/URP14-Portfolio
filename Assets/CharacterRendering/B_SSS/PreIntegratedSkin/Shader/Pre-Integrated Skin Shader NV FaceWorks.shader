Shader "MyURPShader/Character Rendering/Pre-Integrated SkinFaceWorks"
{
    Properties
    {
        ...
        [NoScaleOffset]_SkinShadowLut("Shadow Lut",2D) = "white"{}
    ...
    SubShader
    {
        Tags
        {
            "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "ShaderModel"="4.5"
        }
        LOD 300
        ...
        Pass
        {
            ...
            #pragma fragment PreIntegratedSSSLitPassNVFaceWorksFragment

            //不支持合批是因为后面的Pass用的cbuffer中的内容不一致，此处仅为了演示PBR效果故不更改
            #include "ShaderLibrary\PreIntegratedSkinLitInput.hlsl"
            #include "ShaderLibrary\PreIntegratedSkinLitPass.hlsl"
            ENDHLSL
        }
