...
namespace RenderFeature.PostProcessSystem
{
    ...
    public class GaussianBlur : MyPostProcessing
    {
        ...
        private int gaussianBlurParams = Shader.PropertyToID("_GaussianBlurParams");
        ...
        public override void Render(CommandBuffer cmd, ref RenderingData renderingData, RTHandle source, RTHandle dest)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref gaussianBlurTex1, in descriptor, FilterMode.Bilinear,TextureWrapMode.Clamp,
                name: "_GaussianBlurTex1");
            RenderingUtils.ReAllocateIfNeeded(ref gaussianBlurTex2, in descriptor, FilterMode.Bilinear,TextureWrapMode.Clamp,
                name: "_GaussianBlurTex2");
            material.SetVector(gaussianBlurParams,new Vector4( blurRadius.value,0,0,mipmap.value));
